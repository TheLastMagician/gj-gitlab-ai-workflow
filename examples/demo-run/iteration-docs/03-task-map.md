...
| Review MR | Reviewer | AI review and manual checks | Done |
| Test and record failure | QA | Test Issue #5 and Bug Issue #6 | Done |
| Prepare release | DevOps | Release Issue #7 | Done |
| Retrospective | PM | Retro Issue #8 and summary | Done |
